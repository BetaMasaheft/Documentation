...
<html version="XHTML+RDFa 1.1">
    ...
    <script type="text/javascript" src="resources/js/titles.js"></script>
    <script type="text/javascript" src="resources/js/NewBiblio.js"></script>
    <script type="text/javascript" src="resources/js/PointsHere.js"></script>
</html>
    </xsl:template>
</xsl:stylesheet>

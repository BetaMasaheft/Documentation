<xsl:stylesheet xmlns="http://www.tei-c.org/ns/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:t="http://www.tei-c.org/ns/1.0" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" exclude-result-prefixes="#all" version="2.0">
    ...
    <xsl:template match="//t:left">
        <left>
            ...
            <!--<xsl:if test="document(concat('http://betamasaheft.aai.uni-hamburg.de/images/',$mainidno,'imageList.xml'))//t:surface[@n=$the_folNo]/t:graphic/@url">
                <xsl:attribute name="url">
                    <xsl:value-of select="document(concat('http://betamasaheft.aai.uni-hamburg.de/images/',$mainidno,'imageList.xml'))//t:surface[@n=$the_folNo]/t:graphic/@url"/>
                </xsl:attribute>
            </xsl:if>-->
